...
import { getFinishedBooks, getTitles, getTotalPages, describeBook, addBook, markAsFinished, } from "./utils.js";
// ============================================================
...
console.log(`Original list: ${books.length} books | With new books: ${addBook(books, newBook).length}`);
...
console.log(`Finished before: ${getFinishedBooks(books).length} | Finished after: ${getFinishedBooks(markAsFinished(books, 4)).length}`);
