...
//
// ============================================================
export const getFinishedBooks = (books) => {
...
// ------------------------------------------------------------
export function getTotalPages(books) {
...
// ------------------------------------------------------------
export const addBook = (books, newBook) => [...books, newBook];
// ------------------------------------------------------------
...
// ------------------------------------------------------------
export const markAsFinished = (books, id) => {
    return books.map((book) => book.id === id ? { ...book, finished: true } : book);
};
